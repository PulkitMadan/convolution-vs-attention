...
parser.add_argument('--models-dir', type=str, default='models',
                    help='Directory path to decoder/vgg_normalised.pth')
...
def main():
    ...
    decoder.load_state_dict(torch.load(os.path.join(models_dir, 'decoder.pth')))
    vgg.load_state_dict(torch.load(os.path.join(models_dir, 'vgg_normalised.pth')))
